...
from experiments.m3n_vc.checkpoint_paths import KI_NAMES, checkpoint_candidates
from experiments.m3n_vc.process_data import KNOWN_SCENES, resolve_scene_raw_dir
...
def main() -> int:
    ...
    if ckpt_errors:
        ...
        return 1
        print(
            "\nCheckpoints OK. Download M3N-VC scenes, then: "

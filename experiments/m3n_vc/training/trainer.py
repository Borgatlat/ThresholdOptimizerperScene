...
from experiments.m3n_vc.models.spectrogram_cnn import count_parameters
from experiments.m3n_vc.training.augment import apply_spec_augment
from experiments.m3n_vc.training.losses import (
    LOSS_KEYS,
    build_loss,
    loss_uses_class_weights,
)
from experiments.m3n_vc.training.metrics import compute_metrics
from experiments.m3n_vc.utils.classifier_registry import (
    ClassifierRegistry,
    compute_p_idk,
)
...
def train_ki(
    ...
    if profile_inference:
        from experiments.m3n_vc.training.profile import profile_ki_inference

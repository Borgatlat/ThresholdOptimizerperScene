...
Usage
-----
    python -m experiments.m3n_vc.run_all_scenes                  # all 6 scenes
    python -m experiments.m3n_vc.run_all_scenes --scenes h08 s31 # selected scenes
    python -m experiments.m3n_vc.run_all_scenes --skip-process   # outcomes only, if
...
from experiments.m3n_vc.collect_empirical_outcomes import collect_empirical_outcomes
from experiments.m3n_vc.process_data import save_scene_paired_arrays
